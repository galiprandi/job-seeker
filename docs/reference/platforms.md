...
Community-maintained catalog of 35 platforms in 5 categories. The agent consults it to decide where to search based on your profile.
...
| Remotely | remotely.works | Tech | Mid-Senior | US Startups | Latam to US | No | Low | Manual match. LATAM devs to US startups. USD salary |
...
| LatamCent | latamcent.com | Tech | Mid-Senior | Tech | Latam to US | No | Low | Staffing firm. Top 1% LATAM talent to US companies |
